    ...
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 space-y-12">
      ...
      <header className="max-w-3xl mx-auto text-center space-y-4">
        ...
        <p className="text-stone-600 text-lg leading-relaxed">
          A personalized sanctuary of the hymns and sacred songs that speak most deeply to your heart.
        </p>
      </header>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-stone-200/80 rounded-3xl p-12 sm:p-16 text-center max-w-xl mx-auto space-y-6 shadow-xs animate-fadeIn">
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-2xl font-bold text-stone-900">No Favorites Saved Yet</h3>
            <p className="text-stone-500 text-sm leading-relaxed max-w-md mx-auto">
              You haven&apos;t added any hymns to your personal collection. Click the heart icon on any hymn card to save it here for quick access during worship.
            </p>
          </div>
          <Link
            href="/"
          ...
          >
            <span>Browse Hymnal Catalog</span> <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      )}
    </div>
