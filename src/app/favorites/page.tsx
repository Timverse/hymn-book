...
export default function FavoritesPage() {
  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16 space-y-12 animate-fadeIn">
      {/* Header */}
      <header className="max-w-3xl mx-auto text-center space-y-4">
        ...
        <p className="text-stone-600 text-lg leading-relaxed">
          Your personal collection of cherished hymns for worship.
        </p>
      </header>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-stone-200/80 rounded-3xl p-12 sm:p-16 text-center max-w-xl mx-auto space-y-6 shadow-xs animate-fadeIn">
          ...
          <div className="space-y-2">
            <h3 className="font-serif text-2xl font-bold text-stone-900">No Favorite Hymns Yet</h3>
            <p className="text-stone-500 text-sm leading-relaxed max-w-md mx-auto">
              You haven&apos;t added any hymns to your favorites yet. Click the heart icon on any hymn to save it here for quick access.
            </p>
          </div>
          <Link
            href="/"
