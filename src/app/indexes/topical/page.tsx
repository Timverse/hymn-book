        ...
        {filteredData.length > 0 ? (
          <div className="space-y-12 sm:space-y-14 animate-fadeIn">
            {filteredData.map((group) => (
              <section key={group.topic} className="bg-white border border-stone-200/80 rounded-3xl p-6 sm:p-8 md:p-10 space-y-6 sm:space-y-8 shadow-2xs hover:shadow-md transition-shadow duration-200">
