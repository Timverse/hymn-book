        ...
        {filteredData.length > 0 ? (
          <div className="space-y-12 animate-fadeIn">
            {filteredData.map((group) => (
              <section key={group.name} className="bg-white border border-stone-200/80 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xs hover:shadow-md transition-shadow duration-200">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-stone-100 pb-4 gap-2">
                  <h2 className="font-serif text-2xl md:text-3xl font-bold text-stone-900 flex items-center gap-3">
                ...
                {group.numbers.length > 0 ? (
                  ...
                  <p className="text-stone-400 italic text-sm py-2">Ym pat don jingrwai ba la pynshisha.</p>
                )}
              </section>
            ))}
          </div>
          ...
          <div className="bg-white border border-stone-200/80 rounded-3xl p-12 text-center max-w-lg mx-auto space-y-4 shadow-xs animate-fadeIn">
            <h3 className="font-serif text-xl font-bold text-stone-900">Ym Shem Nongshna</h3>
